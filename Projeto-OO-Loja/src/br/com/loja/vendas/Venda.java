...
public class Venda {
    ...
    public CD comprarCD() {
        ...
        codPesquisar = Utilidades.lerInteiro();
        
        for(int i = 0; i < nRegs; i++) {
            if(gP.listaCD.get(i).getCodigo() == codPesquisar) {
                cd = gP.listaCD.get(i);
            }
        }
    ...
    public DVD comprarDVD() {
        ...
        for(int i = 0; i < nRegs; i++) {
            if(gP.listaDVD.get(i).getCodigo() == codPesquisar) {
    ...
    public Jogo comprarJogo() {
        ...
        for(int i = 0; i < nRegs; i++) {
            if(gP.listaJogo.get(i).getCodigo() == codPesquisar) {
    ...
    public Livro comprarLivro() {
        ...
        for(int i = 0; i < nRegs; i++) {
            if(gP.listaLivro.get(i).getCodigo() == codPesquisar) {
